                    ...
                    >
                        ...
                        <i
                            ...
                            :class="{
                                ...
                                'fa fa-chevron-right big-dark':
                                    !sidebarOpen && isDark,
                                'fa fa-chevron-right big-light':
                                    !sidebarOpen && isLight,
                            }"
                            aria-hidden="true"
                        ></i>
...
import { ICard, MyRootState, RootCommitType, RootDispatchType } from "@/types";
        ...
        listenOnKeyDown(event: any): void {
            ...
            switch (true) {
                case event.key === "c" || event.key === "C":
                    {
                        const translationInputEl = document.querySelector(
                        ...
                        if (
                            translationInputEl?.nodeName ===
                            currentFocusedEl?.nodeName
                        )
                            return;
