            ...
            <div style="display: flex; flex-direction: column">
                ...
                <div style="display: flex; justify-content: center">
                    ...
                    >
                        ...
                        <span id="incorrect-score" class="has-text-danger">
                            Incorrect: {{ incorrect }}
                        </span>
                    </div>
                </div>
        ...
        <Transition type="transition" name="fade" mode="out-in">
            ...
            >
                <div
                    ...
                    :key="i"
                >
                    <Card :id="card._id" :cards="cards" :card="card" />
                </div>
            </div>
...
<script lang="ts">
import { RootCommitType, MyGetters, MyRootState, CardClass } from "../types";
...
export default defineComponent({
    ...
    setup() {
        ...
        const aCategoryIsActive = computed<boolean>(
            () =>
                store.getters[
                    "sidebarCategories/aCategoryIsActive" as MyGetters
                ]
        );
